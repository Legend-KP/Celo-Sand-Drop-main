 ...
 */
export const APP_URL: string = 'https://flow-points-checker.vercel.app';

/**
 * The name of the mini app as displayed to users.
 * Used in titles, headers, and app store listings.
 */
export const APP_NAME: string = 'Flow Points Checker';

/**
 * A brief description of the mini app's functionality.
 * Used in app store listings and metadata.
 */
export const APP_DESCRIPTION: string = 'Check your $Flow Points';
 ...
 */
export const APP_ICON_URL: string = `https://i.ibb.co/dJzkLkvP/Flow-Points-Checker.png`;

/**
 * URL for the app's Open Graph image.
 * Used for social media sharing and previews.
 */
export const APP_OG_IMAGE_URL: string = `https://i.ibb.co/nJsD6pk/Untitled-design-6.png`;

/**
 * URL for the app's splash screen image.
 * Displayed during app loading.
 */
export const APP_SPLASH_URL: string = `https://i.ibb.co/d4qq7kD2/GIF.gif`;
 ...
 */
export const APP_BUTTON_TEXT: string = 'Check Your $Flow Points';
